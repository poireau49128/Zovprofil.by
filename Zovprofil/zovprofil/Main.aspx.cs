    ...
    public partial class Main : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < MainSliderDT.Rows.Count; i++)
            {
                ...
                //img.Attributes.Add("ondblclick", "redirectToCategory()");
                //img.Attributes.Add("ondblclick", "setTimeout(function() { OpenSliderImage(); }, 100);");


                img.Attributes.Add("onclick", "setTimeout(function() { redirectToCategory(); }, 300);");
                img.Attributes.Add("ondblclick", "OpenSliderImage()");

                img.Attributes.Add("onclick", "handleClick(event)");
                img.Attributes.Add("ondblclick", "handleDoubleClick(event)");
                ...
                sliderLinks += MainSliderDT.Rows[i]["MainSliderLink"].ToString() + ";";
                sliderUrls += MainSliderDT.Rows[i]["FileName"].ToString() + ";";
            }

            ScriptManager.RegisterStartupScript(this, this.GetType(), "SetSliderLinks", "SetSliderLinks('" + sliderLinks + "');", true);
