<%@ Page Title="Контакты сотрудников и отделов - фабрика ОМЦ-Профиль" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Contacts.aspx.cs" Inherits="Zovprofil.Contacts" %>
    ...
    <%--<div class="contacts-cont">
            <div>
                <div class="contacts-dep">
                    <div style="height:60px; padding:0 15px; background-color:#83b9ab;">
                    ...
                    <div style="height:60px; padding:0 15px; background-color:#83b9ab; margin-top:20px;">
                    ...
                    <div style="">
                        ...
                        <div class="contacts-item">
                            ...
                            <span class="name">Елена Лозовицкая</span>
...
документов.</span>
    ...
    <div class="container">
        ...
        <div class="scheme">
            <span>Схема проезда:</span>
            <img src="/Images/Contacts/map.png" alt="Alternate Text" />
        </div>
    </div>
