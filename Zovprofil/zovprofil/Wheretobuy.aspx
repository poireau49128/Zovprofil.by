...
можно у дилеров в Вашем городе</span>
    ...
    <div class="dealer-cont">
        <div runat="server" style="position:relative; text-align:left; min-width:700px; min-height:600px;">
            ...
            <div style="position:absolute; z-index:2; -webkit-box-shadow: 0px 0px 14px 0px #c8c8c8; -moz-box-shadow: 0px 0px 14px 0px #c8c8c8; box-shadow: 0px 0px 14px 0px #c8c8c8; float:left; width:400px; margin-left:25px; margin-top:25px; margin-bottom:20px;">
                <div id="CategoriesDiv" runat="server" style="width:360px; float:left; padding:20px; color:rgb(50,50,50); background-color:white; border:1px solid rgb(220,220,220);  font-family:SegoeUIRegular;">
